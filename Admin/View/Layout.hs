...
navbar = [hsx|
    ...
    where
        navItems :: Html
        navItems = maybe loggedOutNav loggedInNav currentAdminOrNothing
        ...
        loggedInNav admin = [hsx|
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="min-width:auto;">
                    <li><h6 class="dropdown-header">{get #email admin}</h6></li>
                    <li><hr class="dropdown-divider" /></li>
                    <li><a  class="dropdown-item" href={EditAdminAction (get #id admin)}>Profile</a></li>
                    <li><hr class="dropdown-divider" /></li>
                    <li>
